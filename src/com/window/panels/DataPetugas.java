...
<<<<<<< HEAD
            ...
            Object[][] obj;
            int rows = 0;
            String sql = "SELECT id_karyawan, nama_karyawan, no_telp, alamat FROM karyawan " + keyword, id;
            // mendefinisikan object berdasarkan total rows dan cols yang ada didalam tabel
            obj = new Object[karyawan.getJumlahData(DatabaseTables.KARYAWAN.name())][4];
            // mengeksekusi query
            karyawan.res = karyawan.stat.executeQuery(sql);
            // mendapatkan semua data yang ada didalam tabel
            while(karyawan.res.next()){
                // menyimpan data dari tabel ke object
                id = karyawan.res.getString("id_karyawan");
                obj[rows][0] = id;
...
<<<<<<< HEAD
        ...
        this.level = text.toCapitalize(karyawan.getLevel(this.idSelected).name());
