...
public class LupaWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlMain.add(btnLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 380, -1, -1));

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/image/gambar/app-lupaPassword-050.png"))); // NOI18N
...
//                if()
            ...
            Logger.getLogger(LupaWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LupaWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new LupaWindow().setVisible(true);
            }
        });
    }
