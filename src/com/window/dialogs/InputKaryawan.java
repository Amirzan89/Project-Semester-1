...
public class InputKaryawan extends javax.swing.JDialog {
    ...
    public InputKaryawan(Frame parent, boolean modal, String idKaryawan) {
        ...
        if(idKaryawan == null){
            ...
            this.level = this.karyawan.getLevel(this.idKaryawan);
    ...
    private void addData(){
        ...
        if(level != null){
            ...
            boolean save = this.karyawan.addPetugas(nama, noTelp, alamat, pass, level);
    ...
    private void editData(){
        ...
        if (this.newLevel != null) {
            // validasi data
            if (this.karyawan.validateAddPetugas(this.idKaryawan, this.newNama, this.newNoTelp, this.newAlamat, this.newPass, this.newLevel)) {
